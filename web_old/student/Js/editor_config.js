...
(function () {
   ...
   URL = "http://192.168.1.66/stu1/ueditor/";
    /**
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["fullscreen","source","undo","redo","insertunorderedlist","insertorderedlist","cleardoc","print","searchreplace","insertimage","snapscreen","spechars","bold","italic","strikethrough","underline","forecolor","backcolor","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","indent","removeformat","formatmatch","imagenone","imageleft","imageright","imagecenter","fontfamily"]]
