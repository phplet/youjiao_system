...
function changesupload(){
		...
		$("#myupload").ajaxSubmit({
			...
			success: function(data) {
				...
				files.append('<div class="tv_main" id="'+srt[0]+'"><ul><li class="tv_main_img">'+picnum+'</li><li class="tv_main_img"><img src="'+img+'" class="theImage" width=30 height=30></li><li class="tv_main_pic"><a href="upload/files/'+data.pic+'" target="_blank">'+data.pic+'</a></li><li class="tv_main_size">('+data.size+'k)</li><li class="tv_main_op" onClick="dele_pic(\''+srt[0]+'\',\''+srt[1]+'\')">删除</li></ul><div class="cleard"></div></div>');
...
function dele_pic(pic,imgtype){
		...
		$.post("upload/action.php?act=delimg",{imagename:pic+"."+imgtype},function(msg){
			if(msg==1){
				var test = $('#anwe1').text();
