...
var clss_nameS = $.cookie("clss_nameS");//班级name c 
		  ...
		  // alert(JSON.stringify(orderQue));
		   ...
		   var subjectname = subject_sum(parseInt(subject_id));
			...
			if(data_tests_Q.testtype==1){ 
				...
				$('.total_wrong').html(result.study_exercise.my_score);
				...
				if(n_1.ids!=""&&n_1.ids!=null){
					$.each(n_1.ids,function(i_2,n_2){
						...
						if(n_2!=""&&n_2!=null){
							...
							htmlContent +='<div class="tijixie"><div class="main_box_3_title"><div class="main_box_3_title_l" id="main_box_3_title_l"><span class="text_005">' + (i_2 + 1) + '</span><span class="text_002">/</span><span class="text_002" id="sjtishu">'+n_1.sum+'</span>'
							if(data_tests_Q.testtype==1){ 
								htmlContent += '<span class="text_003"> 本题分值：' + sorce + '分</span>';
							}
							
							htmlContent += '</div><div class="main_box_3_title_r" id="main_box_3_title_r"><a onclick="goods_ti(\''+n_2.id+'\','+subject_id+',2,'+n_2.dbtype+','+n_2.section_id+')">收藏好题</a>&nbsp;&nbsp;<a class="hf">查看解析</a></div></div><div class="main_box_3_cen"><div class="main_box_3_cen_1" id="main_box_3_cen_1">' + (i_2 + 1) + '、' + ExContent+'</div><div class="main_box_3_cen_2_1"><div class="main_box_3_cen_2_left_1">';
							//附件判定<a onclick="erro_ti(\''+n_2.id+'\','+subject_id+',1)">收藏错题</a>
							if(stuAttachment!=""&&stuAttachment!=undefined){
								//alert(attement_temp);
							htmlContent += '<span class="text_008"><img  src="images/txt.png" width="16" height="16"/></span><span class="text_006">你的附件：';
							...
							if(obj_flag==1){ 
								if(stuAnser==XExanswer){	
						  		htmlContent += '<span class="text_008"><img  src="images/ok.png"/></span><span class="text_006">你的答案：' + stuAnser+' </span><br /><span class="text_008"><img  src="images/ok.png"/></span><span class="text_007">正确答案：<span id="' + QuestionInput.a + n_2.id + '" >' + XExanswer + '</span></span><br />';
								}else{
									htmlContent += '<span class="text_008"><img  src="images/wrong.png"/></span><span class="text_006">你的答案：' + stuAnser+' </span><br /><span class="text_008"><img  src="images/ok.png"/></span><span class="text_007">正确答案：<span id="' + QuestionInput.a + n_2.id + '" >' + XExanswer + '</span></span><br />';
								}
							}else{
