    ...
    layer.tab = function(parme){
        var log = {}, parme = parme || {}, data = parme.data || [], conf = {
            ...
            page: {html: '<div class="xubox_tab" style="'+ function(){
				...
				+'<span class="xubox_botton"><a class="xubox_no xubox_botton2" href="javascript:;">关闭</a></span>'
                +'</div>'
            }, success: function(layerE){
				//parme.success_I;
                //切换事件
                var btn = $('.xubox_tabtit').children(), main = $('.xubox_tab_main').children(), close = $('.xubox_tabclose'),closes = $('.xubox_no');
