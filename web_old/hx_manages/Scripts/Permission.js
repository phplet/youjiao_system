...
(function ($) {
    var operateDefine = [
        { operate: "homePage", level: [1,2,3,4,5,9] },
		...
		{ operate: "OneToOne_Student", level: [4] },
		...
		{ operate: "admission_Examination", level: [2,5] },
		
		{ operate: "admission_Examination_List", level: [2,5] },
		{ operate: "admission_Begin", level: [5] },
		{ operate: "admission_zone", level: [2] },
		{ operate: "admission_standard", level: [2] }
    ];
