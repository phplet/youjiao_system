...
$().ready(function () {
    ...
    $('document').KeyInput($("#SchoolText"), '请输入姓名');
     ...
     var tempcolumns = [[
		    { field: 'teacherUName', title: '学校校区', width: 80, align: 'center', sortable: true },
			{field: 'TeacherRName', title: '班级名称', width: 180, align: 'center'},
			{ field: 'TeacherSubject', title: '学科', width: 60, align: 'center', sortable: true },
			{ field: 'TeacherEmail', title: '发送报告时间', width: 80, align: 'center', sortable: true },
			{ field: 'TeacherRole', title: '任课教师', width: 120, align: 'center', sortable: true },
            {
                field: 'stu_Id', title: '操作', align: 'center',width: 80, 
                formatter: function (value, row, index) {
                    var s = "<div style='line-height:25px;'><a href=\"#\" style='color:blue;' onclick=\"editStudent('" + value + "'," + index + ")\">查看</a>";
                    return s;
                }
            }
...
function LoadSchool(s,l) {
    ...
    $.ajax({
        ...
        type: "GET",
        dataType: "json",
       data: {'action':'xxxx','stu_user_id':rs.stu_user_id},
        success: function (result) {
