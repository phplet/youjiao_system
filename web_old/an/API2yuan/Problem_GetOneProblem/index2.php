			...
			if(true){
				...
				switch($_REQUEST['cateryid']){
						...
						case 2:
							...
							$this -> selectandwrite('*','exam_question',null,null,'id=368842'); 
//echo '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />'.$this -> arr["content"][0];
							break;
						//名校试卷
						case 3:
							$thearr = explode(",",$_REQUEST['allid']);
