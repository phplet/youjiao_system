			...
			if($rs[0]){
				...
				switch($_REQUEST['cateryid']){
						...
						case 2:
							...
							$this -> selectandwrite('exam_question.*','(exam_question JOIN exam_examination ON exam_question.exam_name=exam_examination.name)',null,null,'exam_question.exam_name="'.$_REQUEST['topicid'].'" and '.$f.' '.$subject.' and '.$pai.' order by rand() limit 1');
