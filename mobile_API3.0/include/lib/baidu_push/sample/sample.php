...
function test_pushMessage_android ($user_id)
{
	...
	$message = '{ 
			"title": "this is sky test",
			"description": "晓坤测试",
			"notification_basic_style":7,
			"open_type":1,
			"url":"http://www.51s8s.com"
 		}';
...
echo '<pre>';
//test_pushMessage_android('19987');
//
//test_fetchMessage('19987');

//test_verifyBind('19987');

//test_queryBindList('19987');

test_setTag('名曲', '19987');
test_fetchTag('名曲');
