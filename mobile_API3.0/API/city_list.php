	...
	class crest extends REST{
		...
		public function getList(){
			...
			if(strlen($_REQUEST['condition'])!=0){
				...
				$this -> db -> sql = "select ".$str." from area_city where ".$condition." limit ".$this -> page[0].",".$this -> page[1];
			}
			else{
				$this -> db -> sql = "select ".$str." from area_city limit ".$this -> page[0].",".$this -> page[1];
			}
